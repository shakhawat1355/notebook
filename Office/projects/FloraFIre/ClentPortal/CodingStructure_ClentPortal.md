# Client Portal Coding Structure

### Angular Coding Slyle

-  Here we are using Angular v17.So we will follow the offical coding style guide - [Angular coding style guide
](https://angular.dev/style-guide).

### Angular project Structure

- A project structure is given in the following to present an idea of how Angular project will be structured:
```
∇ app
    ∇ core
         ∇ guards
